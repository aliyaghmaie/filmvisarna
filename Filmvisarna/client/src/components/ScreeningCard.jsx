              ...
              <div className="flex">
                ...
                <div className="ml-4 flex flex-col justify-center gap-3 text-white-100 md:ml-6">
                  <div className="">
                    ...
                    <h2 id="title" name="title" className="font-extra-bold text-base md:text-base lg:text-lg">
                      {screening.movie.title}
                    </h2>
                    <p id="genre" name="genre" className="font-inconsolata text-xs md:text-base lg:text-lg">
                      {screening.movie.genre}
                    </p>
                    <p id="theaterName" name="theaterName" className="font-inconsolata text-xs md:text-base lg:text-lg">
