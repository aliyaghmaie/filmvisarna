    ...
    return (
        <div className="text-white flex flex-col w-4/5 items-center m-auto">
            ...
            <div className="flex flex-col">
                ...
                <input onChange={handleChange} id="email" name="email" value={inputValues.email} className="py-2 px-4 rounded w-[16em] text-black" type="text" />
                <label className="font-inconsolata mt-4"  htmlFor="re-email">Bekräfta mailadress</label>
                <input onChange={handleChange} id="reEmail"  name="reEmail" value={inputValues.reEmail} className="py-2 px-4 rounded text-black" type="text" />
                <label className="font-inconsolata mt-4" id="email" name="email" htmlFor="email">Mobiltelefon</label>
                <input onChange={handleChange} id="phone" name="phone" value={inputValues.phone} className="py-2 px-4 rounded mb-10 text-black" type="text" />
            </div>
        </div>
    )
}
